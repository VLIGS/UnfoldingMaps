...
public class EarthquakeCityMap extends PApplet {
    ...
    private void selectMarkerIfHover(List<Marker> markers) {
        ...
        //You can use the isInside( UnfoldingMap m, float x, float y ) method defined
        //in the AbstractMarker abstract class to check if a location is inside a marker.
        //PApplet Instance variables mouseX and mouseY store the values of the current mouse position.

        for (Marker m : markers) {
            CommonMarker myMarker = (CommonMarker) m;
            if ((myMarker.isInside(map, mouseX, mouseY)) && lastSelected == null) {
                lastSelected = myMarker;
                myMarker.setSelected(true);
                return;
            }
        }
    }
    ...
    private void checkMarkersForClick(List<Marker> myMarkers)
    {
