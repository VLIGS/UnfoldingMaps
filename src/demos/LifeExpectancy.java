...
public class LifeExpectancy extends PApplet {
	...
	public void setup() {
        ...
        lifeExpMap = loadLifeExpectancyFromCSV("/Users/lulu/Documents/LifeExpectancyWorldBankModule3.csv");
		println("Loaded " + lifeExpMap.size() + " data entries");
		

		// Load country polygons and adds them as markers
		countries = GeoJSONReader.loadData(this, "/Users/lulu/Documents/countries.geo.json");
