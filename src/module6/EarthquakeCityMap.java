...
public class EarthquakeCityMap extends PApplet {
   ...
   private void sortAndPrint(int numToPrint)
   {
    EarthquakeMarker [] myArrayOfMarkers = new EarthquakeMarker[quakeMarkers.size()];
       quakeMarkers.toArray(myArrayOfMarkers);
       Arrays.sort(myArrayOfMarkers, Collections.reverseOrder());
       int quakesToPrint;

       if(numToPrint>myArrayOfMarkers.length){
           quakesToPrint = myArrayOfMarkers.length;
       }
       else{
           quakesToPrint = numToPrint;
       }

       for (int quake = 0; quake<numToPrint; quake++){

           System.out.println(myArrayOfMarkers[quake].getMagnitude());
       }
